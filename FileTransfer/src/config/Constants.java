...
public final class Constants {
	...
	public final static int 	DATA_BUFFER_MAXSIZE 		= 5000;
	public final static int 	LISTEN_BUFFER_MAXSIZE 		= 60000;
	public final static int		SENDING_TIMES				= 3;
	public final static int		SENDING_DELAY_PERTIMES		= 300;
	public final static int 	SENDER_DELAY				= ((DATA_BUFFER_MAXSIZE / 4096) + 1) * 0;
